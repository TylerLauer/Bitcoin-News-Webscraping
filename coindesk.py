...
class Coindesk:
    ...
    def getAuthor(self):
        self.Author = self.soup.find("h5", class_="heading").text

    def getTitle(self):
        self.Title = self.soup.find(class_="article-pharagraph").text

    def getDate(self):
        Date = self.soup.find(class_="article-hero-datetime").text
        Date = Date.upper()
